...
# WebServ
## Description
**webserv** is a non-blocking HTTP/1.1 server written entirely in C++ 98. The core objective of this project is to implement the fundamental mechanics of the HTTP protocol and socket programming from scratch, without reliance on modern frameworks.
...
* **HTTP/1.1 Compliance:** Adheres to the semantic standards defined in **RFC 9110**, processing GET, POST, and DELETE requests.
